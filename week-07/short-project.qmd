---
title: "CSC 110 Lab Week 7"
format: html
---

# Counting Names

In this lab session, you will be using [starter code](count_names.py) which contains a function to read a file that contains names and numbers separated by comma (a csv or comma separated file). The function that reads the file and returns a list is already implemented for you.

You are implement three other functions:
...
* `find_name` that takes as argument the dictionary you created the previous function, and a string representing a name. This function returns two types of message (string) depending on whether the name argument is a key in the counts dictionary:
